    ...
    fn build(&self, app: &mut App) {
        ...
        .add_systems(
            ...
            (
                ...
                update_simulation_gizmo,
                update_simulation_params_systems,
            ),
        )
